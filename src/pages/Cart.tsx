...
const Cart = () => {
  ...
  const totalCount = useSelector((state: RootState) => state.cart.items.reduce((sum, item) => {
    ...
    <div className="container container--cart">
      <div className="cart">
        ...
        <div className="content__items">
          {cartPizzas.map(obj => {
            return (
              <CartItem type={obj.type} size={obj.size} key={obj.id} title={obj.title} count={obj.count} price={obj.price} id={obj.id}/>
            )
          })}
        </div>
